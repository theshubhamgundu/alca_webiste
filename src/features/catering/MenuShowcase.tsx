...
export default function MenuShowcase() {
  ...
  const whatsappMessage = useMemo(() => {
    const lines = [
      "Hello ALCA Caterers, I would like a quotation for my event.",
      "",
      "Selected menu items:",
    ];
    ...
    <section id="menu" className="relative overflow-hidden bg-[#F5EDE0] px-6 py-20 md:px-10 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.3em] text-[#C9A96E]">The ALCA Menu Collection</p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-[#6B5040] md:text-base">
            Explore the complete catering menus from the ALCA Catererscollection. From breakfast counters to royal wedding spreads,
        ...
        <div className="mx-auto mt-10 max-w-6xl">
          ...
          <div className="mt-8 flex flex-col gap-4 border border-[#C9A96E] bg-[#7B1E1E] p-5 text-white md:flex-row md:items-center md:justify-between md:p-6">
            <div>
              ...
              <p className="mt-2 text-xs text-white/60">Select dishes above, choose a premium plan below, then send everything to ALCA Caterers.</p>
            </div>
